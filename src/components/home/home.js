            ...
            <React.Fragment>
                <div className="padded-header">
                    <div className="text-center">
                        <h1>Welcome to <a href="http://localhost:3000/apregs"><img src={Beeport} alt="Beeport Logo" height="12.5%" width="12.5%"></img></a>!</h1><br /><br />
                        ...
                        <a href="http://localhost:3000/apregs"><img className="" src={BeeWV} alt="Beeport Logo" height="35%" width="35%"></img></a><br /><br /><br />
