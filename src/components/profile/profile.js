...
import WVBeek from "../report/WVBeek.png"
...
export default class Profile extends Component {
    ...
    render() {
        return (
            <React.Fragment>
                <h2 className="header-text"><a href="http://localhost:3000/home"><img className="bumpup-img" src={Beeport} alt="Beeport Logo" height="20%" width="20%"></img></a><br />
                    Update User Profile</h2>
                <div className="divForm">
                    <form className="profileEditForm">
                        <img className="bumpup-img-2" src={WVBeek} alt="WV Beek" height="12.5%" width="12.5%"></img>
                        <br />
                        <br />
                        <div className="block-right">
                            <h3 className="">
                                Edit Beekeeper Details</h3>
                            ...
                            <input
                                ...
                                className="form-control-md center-details"
                            />
                            <br />
                        ...
                        <label htmlFor="profileListSwarm">Would you like to be included on a "Swarm List", to help the public mitigate identified swarms?:<br />
                            <i className="small-font">*Your name, county and telephone number(s) will be made available to the public for the purpose of removing swarms.</i></label>
                        <br /><select
                            onChange={this.handleFieldChange}
                            type="text"
                            id="profileListSwarm"
                        ...
                        <label htmlFor="profileKeepBees"><b>*</b>Are You Still Keeping Bees?:<br />
                            <i className="small-font">If you are no longer keeping bees, select "No" and we will remove you from our mailing list.</i></label>
                        <br /> <select
                            onChange={this.handleFieldChange}
                            type="text"
                            id="profileKeepBees"
